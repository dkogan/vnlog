...
#include <stdint.h>
  ...
  // asciilog-gen-header
  #define asciilog_emit_record_ctx(ctx)     _asciilog_emit_record     (ctx,      ASCIILOG_N_FIELDS, ASCIILOG_ANCHOR_FIELD_IDX)
  #define asciilog_emit_record()            _asciilog_emit_record     (NULL,     ASCIILOG_N_FIELDS, ASCIILOG_ANCHOR_FIELD_IDX)
  ...
  #define asciilog_flush()                  _asciilog_flush           (NULL,     ASCIILOG_N_FIELDS)
  #define asciilog_flush_ctx(ctx)           _asciilog_flush           (ctx,      ASCIILOG_N_FIELDS)
...
void _asciilog_emit_record(struct asciilog_context_t* ctx,
                           int Nfields, int anchor_field_idx);
...
// or enforce this.
void _asciilog_printf(struct asciilog_context_t* ctx, int Nfields,
                      const char* fmt, ...);
